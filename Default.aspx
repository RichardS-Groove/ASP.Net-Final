...
<body>
    <form id="form1" runat="server">
        <%--Panel Portada--%>
        <asp:Panel ID="pnlPortada" runat="server">
            <asp:ImageButton ID="btnPortada" ImageUrl="~/imagenes/portadao.jpg" runat="server" />
        </asp:Panel>
        <%--Panel Login--%>
        <asp:Panel ID="pnlLogin" runat="server" Width="765px" Height="350px" Font-Bold="true" ForeColor="Orange" Font-Size="Large" BorderStyle="Solid" Visible="false" >
            <%--Tabla Info Login--%>
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td colspan="5" style="text-align:center">
                        <asp:ImageButton ID="btnReenviarClave" ImageUrl="~/imagenes/reenviarclaveo.png" runat="server" Visible="true" />
                        <asp:Label ID="lblReenviarClave" Text="" runat="server"  Visible="false" Font-Bold="true" ForeColor="Orange"/>
                    </td>
                </tr>
            </table>
            ...
            <table style="width:100%">
                <tr>
                    <td style="text-align:center">
                        <asp:ImageButton ID="btnVolverLogin" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" Width="259px" Height="68px" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <%--Panel Menu Login--%>
        <asp:Panel ID="pnlLoginMenu" runat="server" Width="767px" Height="392px" Font-Bold="True" ForeColor="Orange" Font-Size="Large" BorderStyle="Solid" Visible="false">
            <table style="width:100%">
                <tr>
                    <td style="text-align:center">
                        <asp:Image ImageUrl="~/imagenes/registrateo.png" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center">
                        <asp:ImageButton ID="btnRegistrarse" ImageUrl="~/imagenes/registrateaquio.png" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center">
                        <asp:ImageButton ID="btnIrLogin" ImageUrl="~/imagenes/yaregistradoo.png" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center">
                        <asp:ImageButton ID="btnRegistrarseVolverLoginU13" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" Width="259px" Height="68px" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <%--Panel Registrarse--%>
        <asp:Panel ID="pnlRegistrarse" runat="server" ForeColor="#372C57" Font-Size="Large" Visible="false" BackColor="#FFFFFF" Width="">
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td style="text-align:center">
                        <asp:Image ImageUrl="~/imagenes/headero.png" runat="server"  />
                    </td>
                </tr>
                <tr>
        ...
        <%--Panel Bienvenido--%>
        <asp:Panel ID="pnlBienvenido" runat="server" BorderColor="#66CCFF" Height="535px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
        ...
        <%--Panel Area Usuario--%>
        <asp:Panel ID="pnlAreaUsuario" runat="server" BorderColor="#66CCFF" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <table style="width:100%">
                <tr>
                    <td style="text-align:center">
                ...
                <tr>
                    <td style="text-align:center">
                        <asp:ImageButton ID="btnVolverLoginU1" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <%--Panel Ahora que Hago--%>
        <asp:Panel ID="pnlAhoraQueHago" runat="server" BorderColor="#66CCFF" Height="535px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <table style="width: 100%">
                <tr>
                    <td style="text-align: center">
                ...
                <tr>
                    <td style="text-align:center">
                        <asp:ImageButton ID="btnVolverU2" ImageUrl="~/imagenes/terminarvolvero.png" runat="server"/>
                    </td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlPedidosFabrica" runat="server" BorderColor="#66CCFF" Height="489px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
        ...
        <%--Panel Pedido Creado--%>
        <asp:Panel ID="pnlPedidoCreado" runat="server" BorderColor="#66CCFF" Height="389px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr>
                    <td>
        ...
        <%--Panel Historico--%>
        <asp:Panel ID="pnlHistorico" runat="server" BorderColor="#66CCFF" Height="389px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr style="text-align: left">
                    <td colspan="2">
                ...
                <tr style="text-align: center">
                    ...
                    <td>
                        <asp:ImageButton ID="btnTerminarHistorico" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <%--Panel Ver Un Pedido--%>
        <asp:Panel ID="pnlVerUnPedido" runat="server" BorderColor="#66CCFF" Height="389px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr style="text-align: left">
                    <td>
                ...
                <tr style="text-align: center">
                    <td style="text-align: center">
                        <asp:ImageButton ID="btnTerminarVerUnPedido" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <%--Panel Abm Productos--%>
        <asp:Panel ID="pnlAbmProductos" runat="server" BorderColor="#66CCFF" Height="489px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr style="text-align: center">
                    <td>
        ...
        <asp:Panel ID="pnlAltaProductos" runat="server" ForeColor="#372C57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Titulos de Registro e Informacion--%>
            <table style="width: 100%">
                <tr>
                    <td>
                        <asp:Image ImageUrl="~/imagenes/headero.png" runat="server" Width="763px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
        ...
        <asp:Panel ID="pnlProductoCreado" runat="server" BorderColor="#66CCFF" Height="389px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr>
                    <td>
        ...
        <asp:Panel ID="pnlListadoProductos" runat="server" BorderColor="#66CCFF" ForeColor="#372c57" Font-Size="Large" Visible="false" BackColor="#94bbd4">
            ...
            <table style="width: 100%">
                ...
                <tr style="text-align: center">
                    ...
                    <td>
                        <asp:ImageButton ID="btnVolverAbmProducto" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlProductoEditado" runat="server" BorderColor="#66CCFF" Height="389px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr>
                    <td>
        ...
        <asp:Panel ID="pnlAbmPedidosFabrica" runat="server" BorderColor="#66CCFF" ForeColor="#372c57" Font-Size="Large" Visible="false" BackColor="#94bbd4">
            ...
            <table style="width: 100%">
                ...
                <tr style="text-align: center">
                    ...
                    <td>
                        <asp:ImageButton ID="btnVolverAbmPedidosClientes" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlDetallePedidoCliente" runat="server" BorderColor="#66CCFF" ForeColor="#372c57" Font-Size="Large" Visible="false" BackColor="#94bbd4">
            ...
            <table style="width: 100%">
                ...
                <tr style="text-align: center">
                    <td style="text-align: center">
                        <asp:ImageButton ID="btnTerminarVolverAbmFabrica" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <%-- Menu ABM Usuarios --%>
<asp:Panel ID="pnlAbmUsuariosMenu" runat="server" BorderColor="#66CCFF" Height="489px" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondoo.jpg">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr style="text-align: center">
                    <td>
...
<asp:Panel ID="pnlAbmUsuarios" runat="server" BorderColor="#66CCFF" ForeColor="#372c57" Font-Size="Large" Visible="false" BackColor="#94bbd4" style="width: 800px">
            ...
            <table style="width: 100%">
                ...
                <tr style="text-align: center">
                    ...
                    <td>
                        <asp:ImageButton ID="btnTerminarAbmUsuarios" ImageUrl="~/imagenes/terminarvolvero.png" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
